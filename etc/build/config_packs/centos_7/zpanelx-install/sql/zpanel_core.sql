...
CREATE TABLE `x_profiles` (
  ...
  `ud_language_vc` varchar(12) DEFAULT 'Shanghainese',
...
insert  into `x_profiles`(`ud_id_pk`,`ud_user_fk`,`ud_fullname_vc`,`ud_language_vc`,`ud_group_fk`,`ud_package_fk`,`ud_address_tx`,`ud_postcode_vc`,`ud_phone_vc`,`ud_created_ts`) values (1,1,'Default Zadmin','Shanghainese',1,1,'1 Example Road,\r\nIpswich,\r\nSuffolk','IP9 2HL','+44(1473) 000 000',0);
...
INSERT INTO `x_translations` (`tr_id_pk`, `tr_en_tx`, `tr_Shanghainese_tx`) VALUES
(56, 'PHPInfo provides you with information regarding the version of PHP running on this system as well as installed PHP extentsions and configuration details.', 'PHPInfo 为您提供有关此系统上运行 PHP 的版本信息，以及安装的 PHP扩展和配置的详细信息'),
(67, 'From here you can shadow any of your client''s accounts, this enables you to automatically login as the user which enables you to offer remote help by seeing what they see!', '从这里可以映射您的客户的帐户，自动登录他们的账户，让您看到他们所看到的，使您能够给他们供远程帮助！'),
(68, 'My Account', '我的帐户'),
(69, 'Change Password', '更改密码'),
(70, 'Shadowing', '映射'),
(71, 'ZPanel Config', '配置ZPanel'),
(74, 'Report Bug', '报告错误'),
(75, 'Account', '帐户'),
(76, 'Module Admin', '管理模块'),
(77, 'Backup', '备份'),
(78, 'Network Tools', '网络工具'),
(79, 'Service Status', '服务状态'),
(80, 'PHPInfo', 'PHP配置信息'),
(81, 'phpMyAdmin', 'phpMyAdmin'),
(82, 'Domains', '域名'),
(83, 'Sub Domains', '子域名'),
(85, 'Manage Clients', '管理用户'),
(86, 'Package Manager', '套餐管理'),
(87, 'Server', '服务器'),
(88, 'Database', '数据库'),
(89, 'Advanced', '高级'),
(90, 'Mail', '邮件'),
(91, 'Reseller', '代理商'),
(92, 'Account Information', '帐户信息'),
(93, 'Server Admin', '服务器管理'),
(94, 'Database Management', '数据库管理'),
(95, 'Domain Management', '域名管理'),
(98, 'If you have found a bug with ZPanel you can report it here.', '你可以在这里报告你所发现的ZPanel的bug。'),
(99, 'phpMyAdmin is a web based tool that enables you to manage your ZPanel MySQL databases via. the web.', 'phpMyAdmin是一个基于Web的工具，通过它您可以在线管理ZPanel 的MySQL数据库。'),
(100, 'Current personal details that you have provided us with, We ask that you keep these upto date in case we require to contact you regarding your hosting package.', '这里是您的详细资料，我们希望您随时更新这些资料，以便我们在需要的时候能够和您保持联系。'),
(102, 'Change your current control panel password.', '更改你的控制面板密码。'),
(104, 'You can use the tools below to diagnose issues or to simply test connectivity to other servers or sites around the globe.', '您可以使用下面的工具来诊断问题或简单的测试连接到世界各地的其他服务器或网站。'),
(105, 'Here you can check the current status of our services and see what services are up and running and which are down and not.', '在这里你可以检查我们的服务状态，查看哪些服务工作正常，哪些服务挂掉了。'),
(106, 'This module enables you to add or configure domain web hosting on your account.', '此模块可让您添加或配置域名空间。'),
(108, 'This module enables you to add or configure domain web hosting on your account.', '此模块可让您添加或配置域名空间。'),
(109, 'Administer or configure modules registered with module admin', '管理或配置已经在模块管理内登记的模块'),
(110, 'The account manager enables you to view, update and create client accounts.', '帐户管理器可让您查看，更新或建立客户帐户。'),
(111, 'Welcome to the Package Manager, using this module enables you to create and manage existing reseller packages on your ZPanel hosting account.', '欢迎套餐管理器，使用该模块，您能够创建和管理您的ZPanel主机帐户里的套餐。'),
(112, 'Gives you access to your files with drag-and-drop, multiple file uploading, text editing, zip support.', '提供文件拖放，多文件上传，文字编辑，压缩​​功能的支持。'),
(113, 'Secure FTP Applet is a JAVA based FTP client component that runs within your web browser. It is designed to let non-technical users exchange data securely with an FTP server.', '安全FTP Applet是一个基于Java的FTP客户端组件，在网页浏览器内运行。它是为非技术用户提供一个安全的FTP数据交换的服务。'),
(114, 'Full name', '全名'),
(115, 'Email Address', '电子邮件地址'),
(116, 'Phone Number', '电话号码'),
(117, 'Choose Language', '选择语言'),
(118, 'Postal Address', '邮寄地址'),
(119, 'Postal Code', '邮政编码'),
(120, 'Current personal details that you have provided us with, We ask that you keep these upto date in case we require to contact you regarding your hosting package.', '这里是您的详细资料，我们希望您随时更新这些资料，以便我们在需要的时候能够和您保持联系。'),
(121, 'Changes to your account settings have been saved successfully!', '帐户设置的更改已保存成功！'),
(122, 'Update Account', '更新帐户'),
(123, 'Enter your account details', '请输入您的帐户详细信息'),
(124, 'Home', '主页'),
(125, 'File', '文件'),
(126, 'FTP Accounts', 'FTP帐户'),
(127, 'Client Notice Manager', '客户端通知管理'),
(128, 'Manage Groups', '管理组'),
(129, 'Theme Manager', '主题管理'),
(135, 'Domain', '域名'),
(137, 'MySQL Database', 'MySQL数据库'),
(138, 'MySQL Users', 'MySQL用户'),
(139, 'Cron Manager', '计划任务管理'),
(141, 'Webalizer Stats', 'Webalizer 统计'),
(142, 'Admin', '管理'),
(143, 'phpSysInfo', 'php系统信息'),
(145, 'Usage Viewer', '用量查看器'),
(147, 'Current personal details that you have provided us with, We ask that you keep these upto date in case we require to contact you regarding your hosting package.\r\n', '当前您提供给我们的个人资料，我们要求您保留这些最近时间，在我们需要与您联系关于您托管的包裹的情况下。'),
(150, 'Server Information', '服务器信息'),
(151, 'Domain Information', '域信息'),
(152, 'Username', '用户名'),
(153, 'Package name', '包名称'),
(154, 'Account type', '帐户类型'),
(155, 'Last Logon', '最后登录'),
(156, 'Disk Quota', '磁盘配额'),
(157, 'Bandwidth Quota', '带宽配额'),
(158, 'Used', '使用'),
(159, 'Max', '最大'),
(160, 'Sub-domains', '子域名'),
(161, 'Email Accounts', '电子邮件帐户'),
(162, 'Email Forwarders', '电子邮件转发'),
(163, 'MySQL&reg; databases', 'MySQL数据库'),
(164, 'Your IP', '您的IP'),
(165, 'Server IP', '服务器IP'),
(166, 'Server OS', '服务器操作系统'),
(167, 'Apache Version', 'Apache版本'),
(168, 'PHP Version', 'PHP版本'),
(169, 'MySQL Version', 'MySQL版本'),
(170, 'ZPanel Version', 'ZPanel版本'),
(171, 'Server uptime', '服务器运行时间'),
(175, 'The account usage screen enables you to see exactly what you are currently using on your hosting package.', '帐户使用屏幕可以看到正是你目前正在使用你的主机包。'),
(179, 'phpSysInfo is a web-based server hardware monitoring tool which enables you to see detailed hardware statistics of your server.', 'phpSysInfo是一个基于网络的服务器硬件监控工具，它可以让您看到您的服务器的详细硬件统计'),
(181, 'Changes made here affect the entire ZPanel configuration, please double check everything before saving changes.', '所做的更改，这里影响整个ZPanel的配置，请仔细检查之前保存更改的一切。'),
(185, 'Here you can configure PHP scripts to run automatically at different time intervals.', '在这里，你可以配置PHP脚本在不同的时间间隔自动运行。'),
(189, 'You can view many statistics such as visitor infomation, bandwidth used, referal infomation and most viewed pages etc. Web stats are based on Domains and sub-domains so to view web stats for a particular domain or subdomain use the drop-down menu to select the domain or sub-domain you want to view web stats for.', '您可以查看许多统计数据，如访问者infomation，带宽使用，referal的infomation和浏览的网页等网站统计，基于域和子​​域，以便查看一个特定的域或子网站的统计，使用下拉菜单选择域或子域名，你要查看网站统计。'),
(204, 'Enables resellers to set global notices for their clients.', '允许代理商为其客户设置全局通告'),
(207, 'Manage user groups to enable greater control over module permission.', '管理用户组，以便更好地控制模块权限。'),
(210, 'Enables the reseller to set themes configurations for their clients.', '允许代理商为其客户设置主题'),
(212, 'File Management', '文件管理'),
(213, 'Using this module you can create FTP accounts which will enable you and any other accounts you create to have the ability to upload and manage files on your hosting space.', '使用此模块，您可以创建FTP帐户​​，这将使您和您创建的任何其他帐户，有能力，你的虚拟主机空间上的文件上传和管理。'),
(237, 'Delete package', '删除软件包'),
(238, 'Please confirm and choose a package to move any existing clients to before the selected package is deleted.', '请证实并选择一个包移动到选定的包被删除前的任何现有客户。'),
(239, 'Package to delete', '删除包'),
(240, 'Move current package members to', '移动当前包成员'),
(241, 'Delete', '删除'),
(242, 'Cancel', '取消'),
(243, 'Edit package', '编辑包'),
(244, 'Enable PHP', '启用PHP'),
(245, 'Enable CGI', '启用的CGI'),
(246, 'No. Domains', '域名'),
(247, 'No. Sub-domains', '子域'),
(250, 'No. Forwarders', '转发'),
(251, 'No. Dist Lists', '区域列表'),
(252, 'No. FTP accounts', 'FTP帐户'),
(253, 'No. MySQL databases', 'MySQL数据库'),
(254, 'Disk space quota', '磁盘空间配额'),
(255, 'Monthly bandwidth quota', '每月带宽配额'),
(256, 'Save', '保存'),
(257, 'Created', '创建'),
(258, 'No. of clients', '客户号'),
(259, 'Edit', '编辑'),
(260, 'You have no packages at this time. Create a package using the form below.', '在这个时候你有没有包。创建一个包，使用下面的表格。'),
(261, 'Create a new package', '创建一个新的软件包'),
(262, 'Administration', '管理'),
(263, 'Demo', '演示'),
(264, 'Changes to your packages have been saved successfully!', '已保存'),
(267, 'Please confirm that you want to delete this client.', '请确认您要删除此客户端。'),
(268, 'WARNING! This will remove all files and services belonging to this client!', '警告！这将删除所有文件和服务，属于这个客户！'),
(269, 'Move clients and packages (if any exist) this user has to', '移动客户和包（如果有的话），这个用户有'),
(270, 'Edit existing client', '编辑现有的客户端'),
(271, 'Group', '组'),
(272, 'Package', '包'),
(273, 'Reset password', '重设密码'),
(274, 'Current Clients', '现有客户'),
(275, 'Clients', '客户'),
(276, 'Current disk', '当前磁盘'),
(277, 'Current bandwidth', '当前带宽'),
(278, 'You have no client accounts at this time. Create a client using the form below.', '在这个时候你有没有客户帐户。创建一个客户端，使用下面的表格。'),
(279, 'You must first create a Package with the Package Manager module before you can create a client.', '你必须首先创建的软件包管理器模块包之前，您可以创建一个客户端。'),
(280, 'Disabled Clients', '残疾人士'),
(281, 'Create new client account', '创建新客户帐户'),
(282, 'Password', '密码'),
(283, 'Generate Password', '生成密码'),
(285, 'Email subject', '电子邮件主题'),
(286, 'Your ZPanel Account details', '新帐户的详细信息'),
(287, 'Email body', '电子邮件正文'),
(288, 'Administrators', '管理员'),
(289, 'Resellers', '经销商'),
(290, 'Users', '用户'),
(294, 'Enter your current and new password', '请输入您的当前密码和新密码'),
(295, 'Current password', '当前密码'),
(296, 'New password', '新密码'),
(297, 'Confirm new password', '确认新密码'),
(298, 'Change', '改变'),
(300, 'Select the client you wish to shadow', '选择你想要镜像的客户端'),
(301, 'Shadow', '镜像'),
(302, 'You have no Clients at this time.', '在这个时候你有没有客户。'),
(304, 'Never', '从来没有'),
(306, 'Delete database', '删除数据库'),
(307, 'Please confirm that you want to delete this database.', '请确认您要删除这个数据库。'),
(309, 'Database name', '数据库的名称'),
(310, 'Size', '大小'),
(311, 'You have no databases at this time. Create a database using the form below.', '在这个时候你有没有数据库。创建一个数据库使用下面的表格。'),
(313, 'Create', '创建'),
(314, 'You have reached your MySQL database limit!', '你已经达到你的MySQL数据库的限制！'),
(316, 'Delete User', '删除用户'),
(317, 'Please confirm that you want to delete this MySQL user.', '请确认您要删除此MySQL用户。'),
(318, 'Databases for user', '为用户数据库'),
(319, 'Remove from user', '从用户中删除'),
(320, 'Remove database', '删除数据库'),
(321, 'This user currently has no databases. Assign a database using the form below.', '该用户目前还没有数据库。分配一个数据库使用下面的表格。'),
(322, 'Add Database', '添加数据库'),
(323, 'Save Password', '保存密码'),
(325, 'User name', '用户名'),
(326, 'Access', '访问'),
(327, 'Databases', '数据库'),
(330, 'Map Database', '地图数据库'),
(331, 'Remote Access', '远程访问'),
(332, 'Allow from any IP', '允许来自任何IP'),
(333, 'Only from single IP', '指定IP'),
(335, 'Please confirm that you want to delete this domain.', '请确认您要删除此域。'),
(337, 'Domain name', '域名'),
(338, 'Date parked', '停放日期'),
(339, 'Status', '状态'),
(343, 'Changes to your domain web hosting has been saved successfully.', '更改您的域名的虚拟主机已经成功保存。'),
(344, 'Pending', '等待'),
(345, 'Your domain will become active at the next scheduled update.  This can take up to one hour.', '您的域名将成为活跃在下一计划更新。这可能需要长达一小时的时间。'),
(346, 'Current Sub-domains', '当前子域'),
(347, 'Sub-domain', '子域名'),
(348, 'Home directory', '主目录'),
(349, 'You currently do not have any Sub-domains configured. Create a Sub-domain using the form below.', '您目前还没有任何子域配置。创建一个子域使用下面的表格'),
(350, 'Create a new home directory', '创建一个新的主目录'),
(351, 'Use existing home directory', '使用现有的主目录'),
(352, 'You have reached your Sub-domains limit!', '你已经达到您的子域的限制！'),
(353, 'Current domains', '当前域'),
(354, 'You currently do not have any domains configured. Create a domain using the form below.', '您目前还没有任何域配置。创建一个域使用下面的表格。'),
(355, 'You have reached your domain limit!', '你已经达到你的域限制！'),
(356, 'Delete Alias', '删除别名'),
(357, 'Please confirm that you want to delete this Alias.', '请确认您要删除此别名。'),
(358, 'Current Aliases', '当前别名'),
(359, 'Address', '地址'),
(360, 'Destination', '目的地'),
(361, 'You currently do not have any aliases configured on this server.', '您目前还没有这台服务器上配置的任何别名。'),
(362, 'Create a new Alias', '创建一个新的别名'),
(363, 'Alias Address', '别名地址'),
(364, 'Select a domain', '选择一个域'),
(365, 'Select a mailbox', '选择一个邮箱'),
(366, 'Sorry, you have reached your mailbox forward quota limit!', '对不起，你已经达到你的信箱提出的配额限制！'),
(367, 'Delete FTP account', '删除FTP帐户'),
(368, 'Please confirm that you want to delete this FTP account.', '请确认您要删除这个FTP帐户​​。'),
(369, 'Reset FTP Password for user', '重置用户的FTP密码'),
(370, 'Current FTP accounts', '当前FTP帐户'),
(371, 'Account name', '帐户名称'),
(372, 'Permission', '允许'),
(373, 'You do not have any FTP Accounts setup. Create an FTP account using the form below.', '你没有任何FTP帐户​​设置。创建一个FTP帐户​​，使用下面的表格。'),
(374, 'Create a new FTP Account', '创建一个新的FTP帐户'),
(375, 'Access type', '访问类型'),
(376, 'Read-only', '只读'),
(377, 'Write-only', '只写'),
(378, 'Full access', '完全访问'),
(381, 'You have reached your FTP account limit!', '你已经达到您的FTP帐户​​的限制！'),
(382, 'Disk Usage Total', '磁盘使用率总计'),
(383, 'Package Usage Total', '软件包使用总计'),
(384, 'Disk space', '磁盘空间'),
(385, 'Bandwidth', '带宽'),
(386, 'MySQL&reg databases', 'MySQL®数据库的'),
(387, 'Mail forwarders', '邮件转发'),
(388, 'Domain Usage', '域名使用'),
(389, 'Sub-Domain Usage', '子域名的使用'),
(390, 'Parked-Domain Usage', '停放的域名'),
(391, 'MySQL&reg Database Usage', 'MySQL数据库'),
(392, 'FTP Usage', 'FTP使用'),
(393, 'Mailbox Usage', '邮箱'),
(394, 'Forwarders Usage', '代理'),
(395, 'Distribution List Usage', '分發名單用法'),
(396, 'Configure your ZPanel Settings', '设置'),
(397, 'Save Changes', '保存更改'),
(398, 'ZPanel Daemon', '守护'),
(399, 'Next Daemon Run', '下一个守护进程运行'),
(400, 'Last Daemon Run', '最后守护进程运行'),
(401, 'Last Day Daemon Run', '最后一天的守护进程运行'),
(402, 'Last Week Daemon Run', '上周守护进程运行'),
(403, 'Last Month Daemon Run', '上个月守护进程运行'),
(404, 'Queue a full daemon run (reset)', '一个完整的守护进程运行队列（复位）'),
(405, 'Go', '到'),
(406, 'Date Format', '日期格式'),
(407, 'Set the date format used by modules.', '设置模块使用的日期格式。'),
(410, 'From Address', '地址'),
(411, 'The email address to appear in the From field of emails sent by ZPanel.', '电子邮件地址出现在从由ZPanel发送的电子邮件领域。'),
(412, 'From Name', '名称'),
(413, 'The name to appear in the From field of emails sent by ZPanel.', '这个名字出现在从由ZPanel发送的电子邮件领域。'),
(414, 'Icons per Row', '每行的图标'),
(415, 'Set the number of icons to display before beginning a new line.', '设置图标显示，然后再开始一个新行。'),
(416, 'Log Directory', '日志目录'),
(417, 'Root path to directory log folders', '目录中的日志文件夹的根路径'),
(418, 'Mail method', '邮件模式'),
(419, 'Method to use when sending emails out. (mail = PHP Mail())', '发送邮件时，使用方法。（邮件= PHP的mail（））'),
(420, 'Min Password Length', '最小密码长度'),
(421, 'Minimum length required for new passwords', '需要新的密码的最小长度'),
(424, 'Root Drive', '根驱动器'),
(425, 'The root drive where ZPanel is installed.', '根驱动器，安装ZPanel'),
(426, 'Server IP Address', '服务器的IP地址'),
(427, 'If set this will use this manually entered server IP address which is the prefered method for use behind a firewall.', '如果设置使用手动输入服务器的IP地址，这是在防火墙后面使用的更喜欢的方法。'),
(428, 'Service Check Timeout', '服务检查超时'),
(429, 'SMTP Auth method', 'SMTP验证方法'),
(431, 'SMTP Pass', 'SMTP认证'),
(432, 'Password for authentication on the SMTP server.', '验证的SMTP服务器上的密码。'),
(433, 'SMTP Port', 'SMTP端口'),
(434, 'The port address of the SMTP server (usually 25)', 'SMTP服务器的端口地址（通常为25）'),
(435, 'SMTP Server', 'SMTP服务器'),
(436, 'The address of the SMTP server.', 'SMTP服务器的地址。'),
(437, 'SMTP User', 'SMTP用户'),
(438, 'Username for authentication on the SMTP server.', '在SMTP服务器上进行身份验证的用户名。'),
(439, 'Temp Directory', 'Temp目录'),
(440, 'Global temp directory.', '全部缓存目录。'),
(441, 'Use AUTH', '使用AUTH'),
(442, 'SMTP requires authentication. (true/false)', 'SMTP需要身份验证。（是/否）'),
(443, 'Use SMTP', '使用SMTP'),
(444, 'Use SMTP server to send emails from. (true/false)', '使用SMTP服务器发送电子邮件。（是/否）'),
(445, 'ZIP Exe', '邮政编码'),
(446, 'Path to the ZIP Executable', 'ZIP路径'),
(447, 'ZPanel Debug Mode', 'ZPanel调试模式'),
(448, 'Whether or not to show PHP debug errors,warnings and notices', '是否显示PHP调试的错误，警告和通知'),
(449, 'ZPanel Log file', 'ZPanel日志文件'),
(451, 'ZPanel root path', 'ZPanel根路径'),
(452, 'Zpanel Web Root', 'zpanel网站根系'),
(453, 'zsudo path', 'zsudo路径'),
(454, 'Path to the zsudo binary used by Apache to run system commands.', 'Apache使用的zsudo二进制运行系统命令的路径。'),
(457, 'Launch phpSysInfo', '打开phpSysInfo'),
(460, 'Administration Modules', '管理模块'),
(461, 'Apache Config', 'Apache配置'),
(462, 'Backup Config', '备份配置'),
(463, 'DNS Config', 'DNS配置'),
(464, 'FTP Config', 'FTP配置'),
(466, 'Configure Modules', '配置模块'),
(467, 'Module', '模块'),
(468, 'On', '打开'),
(469, 'Off', '关闭'),
(470, 'Category', '类别'),
...
(472, 'Enabled', '启用'),
(473, 'Disabled', '禁用'),
(474, 'N/A (Module Admin)', 'N/A (管理员模块)'),
(475, 'Module Information', '模块信息'),
(476, 'Module name', '模块名称'),
(477, 'Module description', '模块说明'),
(478, 'Module developer', '模块开发'),
(479, 'Module version', '模块版本'),
(480, 'Latest Version', '最新版本'),
(481, 'Module Type', '模块类型'),
(482, 'Install a new module', '安装一个新模块'),
(484, 'Install!', '安装！'),
(486, 'Changes to your module options have been saved successfully!', '模块选项的更改已保存成功！'),
(487, 'Checking status of services...', '检查服务的状态...'),
(488, 'Uptime', '正常运行时间'),
(489, 'Daemon Status', '守护进程的状态'),
(556, 'Current Cron Tasks', '当前的cron任务'),
(558, 'Script', '脚本'),
(559, 'example', '例子'),
(560, 'Comment', '评论'),
(561, 'Executed', '执行'),
(562, 'Every 1 minute', '每1分钟'),
(563, 'Every 5 minutes', '每5分钟'),
(564, 'Every 10 minutes', '每隔10分钟'),
(565, 'Every 30 minutes', '每隔30分钟'),
(566, 'Every 1 hour', '每隔1小时'),
(567, 'Every 2 hours', '每2小时'),
(568, 'Every 8 hours', '每8小时'),
(569, 'Every 12 hours', '每12小时'),
(570, 'Every 1 day', '每1天'),
(571, 'Every week', '每周'),
(573, 'To view Webalizer stats for a particular domain or subdomain use the drop-down menu to select the domain or sub-domain you want to view. Stats may take up to 24 hours before they are generated.', '要查看一个特定的域或子域的Webalizer的统计，使用下拉菜单选择您要查看的域或子域。统计可能采取了24小时才产生。'),
(574, 'Select Domain', '选择域'),
(575, 'Display', '显示'),
(576, 'You currently do not have any domains configured.', '您目前还没有任何域配置。'),
(577, 'Create a new domain', '创建一个新域'),
(578, 'Manage Domains', '管理域'),
(579, 'Choose fom the list of domains below', '选择 fom 域下面的列表'),
(581, 'Select a theme', '选择一个主题'),
(582, 'Theme name', '主题名称'),
(583, 'Theme variation', '主题变化'),
(584, 'Update', '更新'),
(586, 'This module enables you to set a notice banner that will appear when any of your clients access ZPanel. ', '此模块使您可以设置通知的旗帜将出现任何客户访问ZPanel的。'),
(587, 'Client message', '客户端消息'),
(588, 'Notice message', '通知消息'),
(614, 'Delete Distribution List', '删除分发名单'),
(615, 'Please confirm that you want to delete this distribution list.', '请确认您要删除此分发名单。'),
(616, 'Edit Distribution List', '编辑分发名单'),
(617, 'Add New Address', '添加新地址'),
(619, 'Current Distribution Lists', '电流分布列表'),
(620, 'You currently do not have any distribution lists setup.', '您目前还没有任何分发列表的设置。'),
(621, 'Create a new Distribution List', '创建一个新的分发名单'),
(622, 'You have reached your Distribution List quota limit!', '你已经达到您的分发名单配额限制！'),
(624, 'Live', '活动'),
(626, 'Launch phpMyAdmin', '打开phpMyAdmin'),
(631, 'Update your contact email address', '更新您的联系人电子邮件地址'),
(634, 'This module enables you to manage user groups for your client, User groups enable you to control what modules your users can see and access. ', '此模块使您可以管理您的客户端的用户群体，用户组使您能够控制哪些模块，用户可以看到和访问。'),
(635, 'Delete user group', '删除用户组'),
(636, 'Please confirm and choose a group to move any existing clients to before the selected group is deleted.', '请证实并选择一组移动之前选定的组被删除任何现有的客户。'),
(637, 'Please confirm that you want to delete this group.', '请确认您要删除这个组。'),
(638, 'Move current group members to', '移动当前组成员'),
(639, 'Default user groups', '默认用户组'),
(640, 'Description ', '描述'),
(641, 'Current user groups', '当前用户组'),
(642, 'There are currently no custom user groups configured!', '目前有没有自定义的用户组的配置！'),
(643, 'Create new user group', '创建新用户组'),
(644, 'Group name', '组的名称'),
(645, 'Edit user group', '编辑用户组'),
(646, 'The main administration group, this group allows access to all areas of ZPanel.', '主要管理组，该组允许访问所有ZPanel地区。'),
(647, 'Resellers have the ability to manage, create and maintain user accounts within ZPanel.', '经销商有能力管理，创建和维护用户帐户内ZPanel。'),
(648, 'Users have basic access to ZPanel.', '用户有基本访问ZPanel。'),
(666, 'Delete Forwarder', '删除转发器'),
(667, 'Please confirm that you want to delete this forwarder.', '请确认您要删除此转发。'),
(668, 'Current Forwarders', '目前代理'),
(669, 'Keep Message', '保持消息'),
(670, 'Sorry there are currently no mailbox forwards configured!', '很抱歉目前没有邮箱转发配置！'),
(671, 'Create a new forward', '创建一个新的前锋'),
(672, 'Keep original message', '保持原始邮件'),
(778, 'No records were found for this domain.  Click the button below to set up your domain records for the first time', '没有记录，发现该域名。点击下面的按钮，您的域名记录，首次设立'),
(779, 'Create Records', '创建记录');
